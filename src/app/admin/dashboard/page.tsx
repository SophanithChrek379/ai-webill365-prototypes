...
import { Container, Row, Col, Card, Badge, Form, InputGroup, Table } from 'react-bootstrap';
...
const getStatusBadge = (status: string) => {
  switch (status) {
    ...
    case 'Rejected':
      return <Badge bg="danger" className="status-badge">Rejected</Badge>;
    case 'Requested':
      return <Badge bg="primary" className="status-badge">Requested</Badge>;
    case 'Inactive':
      return <Badge bg="warning" className="status-badge">Inactive</Badge>;
    default:
        ...
        <div className="admin-content">
          ...
          <div className="activities-section">
            <div className="activities-header">
              ...
              <p className="activities-subtitle">Latest subscriber applications requiring review</p>
            </div>
              ...
              <div className="d-flex gap-3 align-items-center">
                ...
                <Button variant="primary" outline size="sm" className="status-filter-btn">
                  ...
                  Status
                              ...
                              <div className="d-flex gap-3 align-items-center">
                  <Button variant="primary" outline size="sm" className="view-btn">
